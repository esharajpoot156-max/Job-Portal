...
const Chat = () => {
    ...
    const isReceiverRecruiter = receiver?.role === "recruiter";
    const receiverName = isReceiverRecruiter ? receiver?.companyName : receiver?.fullname;
    const receiverAvatar = isReceiverRecruiter ? receiver?.companyLogo : receiver?.profile?.profilePhoto;
        ...
        <div className="flex flex-col h-[calc(100vh-73px)] bg-white dark:bg-[#121214] dark:text-white">
            <div className="p-4 border-b dark:border-gray-700 font-semibold flex items-center justify-between gap-3">
                <div className="flex items-center gap-3">
                    ...
                    {receiverAvatar ? (
                        <img src={receiverAvatar} alt={receiverName || "avatar"} className="w-8 h-8 rounded-full object-cover shrink-0" />
                    ) : (
                        <div className="w-8 h-8 rounded-full bg-[#8B5CF6] text-white flex items-center justify-center text-sm shrink-0">
